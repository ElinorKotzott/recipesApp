    ...
    return (
        <Form className="create-container" onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="ingredients">
                ...
                <Form.Group className="mb-3 d-flex justify-content-start align-items-center gap-2"
                    ...
                    <PrimaryButton className="mt-2 add-or-remove-button" onClick={handleAddIngredient}>
                        +
                    </PrimaryButton>
                </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="steps">
                ...
                <div className="d-flex justify-content-start align-items-center gap-2">
                    <p className="mb-0">{stepsList.length + 1}.</p>
                    ...
                    <PrimaryButton onClick={handleAddStep} className="add-or-remove-button">
                        +
                    </PrimaryButton>
                </div>
